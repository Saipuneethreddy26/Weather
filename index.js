async function success ()  {
    ...
    if (input !== "") {
        p.style.cssText = "display:flex;flex-wrap:wrap;justify-content:space-evenly;align-items:center;"
    }
   ...
   await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${input}&appid=4810e142098401e123eed7a66306dcba`)
        .then(res => res.json())
        .then(data => {
            console.log(data);
